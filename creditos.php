...
<head>
	...
	<!-- <script type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.4/jquery.lazy.js"></script> -->
	...
	<div class="container">
		...
		<article class="content">
			<table id="tablaAutores">
				<thead>
					<tr>
						<td><img src="img/loading.gif" data-src="https://github.com/FerMod.png" class="modalImage lazyImage"></td>
						<td><img src="img/loading.gif" data-src="https://github.com/FosterGun.png" class="modalImage lazyImage"></td>
					</tr>
				</thead>
				<tbody>
					<tr>
